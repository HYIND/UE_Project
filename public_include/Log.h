...
static const std::string log_path = Config::Instance()->Read<std::string>("log_path", "log.txt");
...
private:
	Logger()
	{
		m_logger = spdlog::rotating_logger_mt("file_logger", log_path.c_str(), MAX_LOGSIZE, MAX_LOGFILE);
